...
namespace DataAccess.Migrations
{
    ...
    [Migration("20250914171522_AddBlogPost")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.BlogPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.PostTag", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.Comment", b =>
                {
                    b.HasOne("ApplicationCore.Entities.Concrete.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Concrete.PostTag", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Concrete.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
